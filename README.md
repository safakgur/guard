...
* Guard has always been in an awkward position:
  ...
  App developers didn't need Guard, as their validation scenarios don't involve throwing argument
  ...
  specifically targeted library authors, Guard has mostly been irrelevant to app developers.
...
* Light validations with `[CallerArgumentExpression]`:
