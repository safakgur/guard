namespace Dawn.Tests
{
    ...
    public sealed partial class GuardTests
    {
        ...
        public void GuardSupportsSingles()
        {
            ...
            var @null = null as float?;
            var nullArg = Guard.Argument(() => @null);
            nullArg.NaN();

            var nullableNaN = nan as float?;
            var nullableNaNArg = Guard.Argument(() => nullableNaN);
            nullableNaNArg.NaN();

            var nullableZero = zero as float?;
            ...
            // Infinity.
            var negInfinity = float.NegativeInfinity;
